...
public class GameInitialization
{
    public GameInitialization(Controllers controllers, int numberoflvl)
    {
        ...
        var coinmodel = new ModelCoin(0);
        var canvasinitialization = new CanvasInitialization(canvasfactory);
        var radarinitialization = new RadarInitialization(bonusinitialization.GetBonuses());
        var radardeleteinitialization = new DeleteRadarElementInitialization(radarinitialization.GetRadarObjects(), new DeleteActionInitialize());
        var leveldestroyinitialization = new LevelDestoyerInitialization(playerinitialization.GetPlayer(), enemyinitialization.GetEnemy(), lvlinitialization.GetLvl(), 
                                                                         bonusinitialization.GetBonuses(), canvasinitialization.GetCanvas(), radarinitialization.GetRadarObjects());
        ...
        controllers.Add(radarinitialization);
        controllers.Add(radardeleteinitialization);
        controllers.Add(leveldestroyinitialization);
        ...
        controllers.Add(new PositiveBonusController(bonusinitialization.GetBonuses(), playerinitialization.GetPlayer(), playerinitialization.GetAndSetSpeed(), radardeleteinitialization.GetRadarDeleteIcon()));
        controllers.Add(new NegativeBonusController(bonusinitialization.GetBonuses(), playerinitialization.GetPlayer(), playerinitialization.GetAndSetSpeed(), radardeleteinitialization.GetRadarDeleteIcon()));
        controllers.Add(new RequiredBonusController(bonusinitialization.GetBonuses(), playerinitialization.GetPlayer(), numberofRequiredBonusUnits, bonusinitialization, radardeleteinitialization.GetRadarDeleteIcon()));
        controllers.Add(new RadarController(radarinitialization.GetRadarObjects(), canvasinitialization.GetCanvas().transform));
        controllers.Add(new CoinController(coinmodel, canvasinitialization.GetCoinViewComponent(), bonusinitialization));
